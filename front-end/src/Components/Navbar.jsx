                    ...
                    <div className="px-4 py-2 space-y-2">
                        ...
                        {isLoggedIn && (
                            <a
                                ...
                                className="block py-2 text-gray-600 hover:text-red-600 transition-colors duration-300 cursor-pointer"
                            >
                                Profile
                            </a>
                        )}
                        ...
                        <button onClick={() => { navigate("/available") }} className="w-full bg-red-600 text-white px-6 py-2 rounded-full hover:bg-red-700 transition-colors duration-300">
                            Available Ambulances
                        </button>
                    </div>
                </div>
